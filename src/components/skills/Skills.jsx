...
const Skills = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0c0c1d] to-[#111132] px-4 md:px-8 lg:px-16 text-gray-200">
      ...
      <div className='font-medium grid grid-cols-2 items-center justify-center gap-3 md:gap-6'>
        {
          skills.map((skill, index) => <div key={index} className='flex items-end gap-2 md:gap-5'>
      ...
      <div>
        ...
        <div className='font-medium grid grid-cols-2 items-center justify-center gap-3 md:gap-8'>
          {
